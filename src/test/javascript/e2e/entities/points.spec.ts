...
describe('Points e2e test', () => {
    ...
    it('should load Points', () => {
        ...
        expect(pointsComponentsPage.getTitle()).toMatch(/jhealthcheckApp.points.home.title/);
    ...
    it('should load create Points dialog', () => {
        ...
        expect(pointsDialogPage.getModalTitle()).toMatch(/jhealthcheckApp.points.home.createOrEditLabel/);
