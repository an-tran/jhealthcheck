...
import com.antt.service.dto.UserDTO;
import com.antt.web.rest.errors.BadRequestAlertException;
import com.antt.web.rest.errors.EmailAlreadyUsedException;
import com.antt.web.rest.errors.LoginAlreadyUsedException;
import com.antt.web.rest.vm.ManagedUserVM;
import com.antt.web.rest.util.HeaderUtil;
import com.antt.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    @PutMapping("/users")
    @Timed
    @Secured(AuthoritiesConstants.UPDATE_USER)
    ...
    @Timed
    @Secured(AuthoritiesConstants.DELETE_USER)
